...
urlpatterns = [
    ...
    # path('password-reset/done /', auth_view.PasswordResetConfirmView.as_view(template_name='password_reset_done.html', ), name='password-reset-done'),
    # path('password-reset-confirm/<uidb64>/<token>/', auth_view.PasswordResetDoneView.as_view(template_name='password_reset_confirm.html', form_class=MySetPasswordForm),  name='password-reset-confirm'),
